module RequestRailsHelper
  ...
  def seed_test_db
    ...
    @item3 = create(:item, unit_price: 1, merchant: @merchant2)
    @item4 = create(:item, unit_price: 1, merchant: @merchant3)
    @item5 = create(:item, unit_price: 1, merchant: @merchant3)
    @item6 = create(:item, unit_price: 1, merchant: @merchant4)
    @item7 = create(:item, unit_price: 1, merchant: @merchant5)
    @item8 = create(:item, unit_price: 1, merchant: @merchant6)
    @item9 = create(:item, unit_price: 1, merchant: @merchant7)
    @item10 = create(:item, unit_price: 1, merchant: @merchant7)
    @item11 = create(:item, unit_price: 1, merchant: @merchant9)
    @item12 = create(:item, unit_price: 1, merchant: @merchant10)
    @item13 = create(:item, unit_price: 1, merchant: @merchant7)
    @item14 = create(:item, unit_price: 1, merchant: @merchant7)
    @item15 = create(:item, unit_price: 1, merchant: @merchant8)
    @item16 = create(:item, unit_price: 1, merchant: @merchant10)
    @item17 = create(:item, unit_price: 1, merchant: @merchant5)
    @item18 = create(:item, unit_price: 1, merchant: @merchant5)
